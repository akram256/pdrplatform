	...
	<nav class="navbar navbar-default container">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><a data-toggle="tab" href="#menu1">TECH</a></li>
				<li><a data-toggle="tab" href="#menu3">SPONSORS</a></li>
				<li><a href="#login" data-toggle="modal">cRoWdFund</a></li>
				<li><a href="#login" data-toggle="modal">SURVEY</a></li>
				<li><a href="#login" data-toggle="modal">ABOUT PDR</a></li>
				<li class="dropdown"><a href="#login" data-toggle="modal" >TEAMS <span class="caret"></span></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#myModal" data-toggle="modal" ><span class="glyphicon glyphicon-user"></span>
						Sign Up</a></li>
				<li><a href="#login" data-toggle="modal"><span class="glyphicon glyphicon-log-in"></span>
						Login</a></li>
				<!--<li><a href="#myModal" data-toggle="modal"><span
						class="glyphicon glyphicon-arrow-right"></span>Sign Up</a></li>-->
			</ul>
		</div>
	</nav>
			...
			<div class="tab-content">
				...
				<div id="menu5" class="tab-pane">
					...
					<div id="page-menus justify-content-center">
						<a id="get_1" style="cursor: pointer">1</a>
						<a id="get_2" style="cursor: pointer">2</a> 
						<a id="get_3" style="cursor: pointer">3</a> 
						<a id="get_4" style="cursor: pointer">4</a>
						<a id="get_5" style="cursor: pointer">5</a> 
						<a id="get_6" style="cursor: pointer">6</a>
					</div>
